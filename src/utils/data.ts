...
export const data: Data = {
  questions: [
    ...
    },
    {
      ...
      question_text:
        'During a regular week, how often do you have a burning sensation behind your sternum (heartburn)',
      answers: [
        { id: 'heartburn_weekly_burns_0_to_3', label: '0-3 days', score: 0 },
        { id: 'heartburn_weekly_burns_4_to_7', label: '4-7 days', score: 10 },
      ],
      next: [{ next_question: 'heartburn_weekly_gastric' }],
    },
    {
      id: 'heartburn_weekly_gastric',
      question_text:
        'During a regular week, how often do you feel gastric content (solid or liquid) moving upwards against the throat or mouth (regurgitation)?',
      answers: [
        { id: 'heartburn_weekly_gastric_0_to_3', label: '0-3 days', score: 0 },
        { id: 'heartburn_weekly_gastric_4_to_7', label: '4-7 days', score: 10 },
      ],
      next: [{ next_question: 'heartburn_weekly_pain' }],
    },
    {
      id: 'heartburn_weekly_pain',
      question_text:
        'During a regular week, how often do you have pain in the upper and middle part of the stomach?',
      answers: [
        { id: 'heartburn_weekly_pain_0_to_3', label: '0-3 days', score: 0 },
        { id: 'heartburn_weekly_pain_4_to_7', label: '4-7 days', score: 10 },
      ],
      next: [{ next_question: 'heartburn_weekly_nauseus' }],
    },
    {
      ...
      next: [{ next_question: 'heartburn_weekly_sleep' }],
    },
    {
      id: 'heartburn_weekly_sleep',
      question_text:
        'During a regular week, how often are you struggling to sleep well because of heartburn and / or regurgitations?',
      answers: [
        { id: 'heartburn_weekly_sleep_0_to_3', label: '0-3 days', score: 0 },
        { id: 'heartburn_weekly_sleep_4_to_7', label: '4-7 days', score: 10 },
      ],
      next: [{ next_question: 'heartburn_swallowing' }],
    },
    {
      ...
      next: [{ next_question: 'heartburn_blood_stool' }],
    },
    {
      ...
      next: [{ next_question: 'heartburn_lost_weight' }],
    },
    {
  ...
  outcomes: [
    {
      ...
      text: 'Your symptom description indicates that this is a self-healing condition. We recommend that you rest for few days. Contact a doctor if your condition gets worse or if symptoms remain for more than three days.',
      show_booking_button: false,
    },
    {
      id: 'see_a_doctor',
      text: 'Your symptom description indicates that you are in need of medical care. Book an appointment with a doctor as soon as possible.',
